    ...
    <div className="bg-canvas2 border-y border-stroke overflow-hidden relative">
      ...
      <div className="py-3 overflow-hidden">
        <div className="flex whitespace-nowrap animate-marquee">
          <span className="font-mono text-[11px] tracking-[3px] text-ink-dim inline-block">{repeated}</span>
          <span className="font-mono text-[11px] tracking-[3px] text-ink-dim inline-block" aria-hidden>{repeated}</span>
        </div>
      </div>
    </div>
  );
